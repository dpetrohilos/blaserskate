...
<cite>–Justin Cornett, 
Louisville, KY </cite>
<img height="60" width="60" class="circle" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/people/justin.jpg"/>
</div>
</div>
...
<div class="second-row"><img width="2400" height="1200" alt="hand crafted, made with love, picture of the skateboard. Illustration of the dragon and logo" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/handcrafted@3x.png"/>
</div></div>


<div class="grid grid-row-4 col-wrapper">
<div class="grid-item-1 col-1"><img class="circle" height="60" width="60" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/people/korey.jpg"/></div>
