...
<h1 class="section-title">Handcrafted skateboards</h1>
...
<img width="2400" height="1200" class="hero-image" alt="Skateboarder doing a trick" src="<?php echo esc_url( get_template_directory_uri() ); ?>/img/BlaserBoardHero_v2.jpg"/>
